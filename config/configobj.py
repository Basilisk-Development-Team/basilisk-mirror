...
class Builder:
    ...
    def build_List(self, o):
        return [self.build(el) for el in o.elts]
    ...
    def build_Tuple(self, o):
        return tuple(self.build(el) for el in o.elts)
    ...
    def build_BinOp(self, o):
        if not isinstance(o.op, ast.Add):
            raise UnknownType('BinOp')
        real = self.build(o.left)
        imag = self.build(o.right)
        try:
            real = float(real)
        except TypeError:
            raise UnknownType('BinOp')
    ...
    def build_UnaryOp(self, o):
        value = self.build(o.operand)
        if isinstance(o.op, ast.USub):
            return -value
        if isinstance(o.op, ast.UAdd):
            return value
